...
class UtilsTest(unittest.TestCase):
    def test_wildcarddict(self):
        ...
        self.assertRaises(KeyError, wd.__getitem__, ("authors", 1, "affiliation"))
        ...
        self.assertRaises(KeyError, wd.query_path, ("apple", "banana", "mango"))
    ...
    def test_dot_lookup(self):
        ...
        self.assertEqual(
            dot_lookup({"a": {"b": "hello"}}, "a.b", parent=True), {"b": "hello"}
        )
        self.assertEqual(dot_lookup({"a": {"b": "hello"}}, ""), {"a": {"b": "hello"}})
    ...
    def test_strip_removed_objects_list(self):
        ...
        self.assertEqual(strip_removed_objects(object_list), expected_object_list)
    ...
    def test_strip_removed_objects_dict(self):
        ...
        self.assertEqual(strip_removed_objects(object_dict), expected_object_dict)
    ...
    def test_strip_removed_objects_nested(self):
        ...
        self.assertEqual(strip_removed_objects(object_nested), expected_object_nested)
